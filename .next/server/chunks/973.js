...
/* harmony export */   "helpPhrases": () => (/* binding */ helpPhrases)
/* harmony export */ });
const helpPhrases = [
    ...
    "Тот, кто обеспокоен своими бедами, никогда не узнает истинной любви и сострадания. Любить по-настоящему могут только те, кого личное больше не тревожит\xbb.",
    "Каждое ваше мнение о чем-либо способно стать ограничением\xbb",
